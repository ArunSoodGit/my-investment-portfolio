...
public class AuthController {
    ...
    @Post("/refresh")
    public HttpResponse<LoginResponseDto> refreshToken(@Body final RefreshTokenRequestDto request) {
        log.debug("Received token refresh request");
        final LoginResponseDto response = authService.refreshToken(request);
